<template>
  <Container>
    <div v-if="isAuthenticated" class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
      <div id="profile"
           class="w-full lg:w-3/5 rounded-2xl lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
        <div class="p-4 md:p-12 text-center lg:text-left">
          <!-- Image for mobile view-->
          <div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center"
               :style="`background-image: url(${user.avatar || 'https://source.unsplash.com/EVCX6ph5o2Y'})`"></div>
          ...
          <div class="pt-12 pb-8">
            <RouterLink to="/profile/edit"
                        class="bg-sky-500 hover:bg-sky-700 duration-200 text-white font-bold py-3 px-4 rounded-full">
              Edit Profile
            </RouterLink>
          </div>
        </div>
      ...
      <div class="w-full lg:w-2/5">
        <img :src="user.avatar || 'https://source.unsplash.com/EVCX6ph5o2Y'"
             class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" alt="">
      </div>
    </div>
  </Container>
</template>
