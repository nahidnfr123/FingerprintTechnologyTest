      ...
      <Container>
        <div class="flex items-center justify-between py-6 md:justify-start md:space-x-10">
          ...
          <div class="-my-2 -mr-2 md:hidden">
            <PopoverButton
                class="inline-flex items-center justify-center rounded-md bg-white p-2 text-primary-color bg-gray-100 hover:bg-gray-200 focus:outline-none">
          ...
          <PopoverGroup as="nav" class="hidden space-x-10 md:flex">
            <template v-for="(nv, n) in navigationLinks" :key="n">
              <RouterLink :to="nv.link" exact-active-class="text-indigo-600"
                          class="text-base text-lg font-medium text-black hover:text-gray-900 duration-300">{{
                  nv.title
                }}
              </RouterLink>
            </template>
          ...
          <div class="px-5 pt-5 pb-6">
            <div class="flex items-center justify-between">
              ...
              <div class="-mr-2">
                ...
                <PopoverButton
                    class="inline-flex items-center justify-center rounded-md bg-white p-2 text-red-600 bg-gray-100 hover:bg-gray-200 focus:outline-none">
            ...
            <div class="mt-16">
              ...
              <nav class="grid gap-y-8">
                <RouterLink v-for="(nv, v) in navigationLinks" :key="v" :to="nv.link"
